...
28 skills available. Skills start at 0 and are raised through practice or reading. At character creation you can invest points to start with skill levels.
...
### rifles
Classic rifles have terrific range and accuracy compared to other firearms, but may be slow to fire and reload, and can prove difficult to use in close combat.  Short-barreled rifles and carbines are more like SMGs and perform well in close combat.
